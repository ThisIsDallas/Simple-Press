...
<link href='http://fonts.googleapis.com/css?family=Droid+Serif' rel='stylesheet' type='text/css'>	
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-34952131-1']);
...
<body <?php body_class(); ?>>
	...
	<div class="top-head">
		<div class="container">
			<header id="header" class="six columns alpha">
				<h4><a href="<?php echo get_option('home'); ?>/"><?php bloginfo('name'); ?></a></h4>	
			</header>			
			<div class="ten columns omega"><?php wp_nav_menu( array('menu' => 'main_nav', 'container' => 'div', 'container_id' => 'main-nav' )); ?></div>
		</div>
	</div>
